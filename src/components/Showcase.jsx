        ...
        <div className="grid md:grid-cols-3 gap-8">
          {sessions.map((session, index) => (
            <motion.div
              ...
              className="group relative rounded-xl overflow-hidden cursor-pointer shadow-2xl shadow-black/50"
            >
              <img 
                src={session.thumbnail} 
                alt={session.title}
                className="w-full aspect-video object-cover transition-transform duration-500 group-hover:scale-110 opacity-60 group-hover:opacity-100"
              />
